...
export function Hero() {
  ...
  return (
    // Top padding clears the fixed bar at both breakpoints — the nav is out of
    // flow, so nothing else reserves that space.
    <header id="top" className="relative pt-[clamp(88px,15vh,104px)] pb-[clamp(48px,7vw,80px)] md:pt-[clamp(96px,11vh,124px)]">
