...
import { CONTINUE_WATCHING } from "@/lib/data/academy";

export function ContinueWatchingCard() {
  const { moduleLabel, lessonTitle, progressPercent, timeLeft, duration } = CONTINUE_WATCHING;
